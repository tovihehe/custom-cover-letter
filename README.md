...
1. **Clone the Repository**:
   ...
   ```bash
   git clone https://github.com/tovihehe/custom-cover-letter.git
...
2. **Modify the Script**:
   - Open `custom_cover_letter.py` and update the placeholders with the desired values.
...
4. **Run the Script**:
   ...
   ```bash
   python custom_cover_letter.py
   ```

   The script will generate a customized cover letter and convert it to PDF format as `cover_letter.pdf`.
